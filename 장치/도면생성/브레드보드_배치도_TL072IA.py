...
wire((19,'B'),(19,'TV'))           # 10
wire((22,'I'),(22,'BV'))           # 11
part((5,'I'),(5,'BG'),'Rb2',lp=(cx(4)-8,(RY['I']+Y('BG'))/2+6),anc='end')
part((13,'I'),(13,'BG'),'Rb1',lp=(cx(12)-8,(RY['I']+Y('BG'))/2+6),anc='end')
...
part((21,'I'),(21,'BG'),'R4′',lp=(cx(20)-8,(RY['I']+Y('BG'))/2+6),anc='end')
part((24,'H'),(25,'C'),'C1',"#93b7dd",32,lp=(cx(26.2),(GUT_T+GUT_B)/2+6),anc='start')
...
for i,t in enumerate([
 ...
 '1 Ω 두 개는 점퍼선 대신이다 — 되먹임에 넣는 1 Ω 은 전기적으로 점퍼와 같다. 부품끼리 겹쳐 눕는 자리가 있는데 리드만 제 구멍에 들어가면 된다.']):
