...
> **자극 간격 2초 · 최소 50회 평균** — 이 논문이 쓴 값이다.

### §2.3.1 접점 공유 — 인접 채널이 접점을 나눠 쓴다 (원문 확인)
...
> ⚠ **자주 인용되는 MGF 15–30 m/s 보다 넓은 범위다.**
...
**[21] = Günther 1976, *J Comp Neurol* 168(4):505–531.**

**즉 이 논문은 기능적 유사성만 말하고 분자적 동일성은 말하지 않는다.**
오히려 "구조적 차이가 있다"고 명시한다.
→ [`../정정기록.md`](../정정기록.md) 「철회된 주장」의 판단이 옳았음이 원문으로 확인됐다.
...
- **비침습이 아니다.** 지렁이가 **생리식염수에 잠겨** 있고 머리·꼬리는 **바늘로 핀 고정**돼 있다.
  ...
  **전도성 액체가 세포외 신호를 단락시켰을 가능성이 있다**(우리 추론).
...
- **같은 개체를 반복 측정했을 때의 변동을 보고하지 않는다.** ±0.87은 12마리에 걸친 SEM이다.
